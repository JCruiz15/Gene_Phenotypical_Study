...
En nuestro caso, usaremos la ontología de GO (\textit{Gene Ontology} \ref{GO}) y la ontología de HPO (\textit{Human Phenotype Ontology database} \ref{HPO}) \cite{hpo_web}. Dicha  ontología se encarga de mostrar las relaciones entre genes de diversas especies y HPO almacena ontologías asociadas a fenotipos de enfermedades del ser humano.
